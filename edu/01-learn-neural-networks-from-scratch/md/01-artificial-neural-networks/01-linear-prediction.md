...
人类自身神经系统是由大量的神经元细胞组成的网络，每个单独的神经元细胞只能对少量的生物信号进行有限地处理。类似的结构在计算机领域并不少见，比如CPU中大量的逻辑计算单元，或者存储器中大量的存储单元。而人工神经元网络（Artificial Neural Network，缩写ANN）则是由大量的人工神经元（artificial neuron，简称neuron）组成。
